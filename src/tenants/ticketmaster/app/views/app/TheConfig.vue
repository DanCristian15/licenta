<template>
    <div>
        ...
        <v-flex class="mt-4 d-flex flex-row align-center">
            <v-label>Force Dynamic Flow</v-label>
            <v-switch v-model="forceDynamicFlow" class="my-0 ml-4 mr-0" inset hide-details />
        </v-flex>
    </div>
</template>
<script>
    ...
    export default {
        ...
        computed: {
            ...
            forceDynamicFlow: {
                get() {
                    return this.$store.state.appState.forceDynamicFlow;
                },
                set( value ) {
                    this.setForceDynamicFlow( value );
                }
            }
        },
        methods: {
            ...mapActions ( {
                ...
                setForceDynamicFlow: 'appState/setForceDynamicFlow'
            } ),
