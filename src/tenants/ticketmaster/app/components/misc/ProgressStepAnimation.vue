        ...
        <div 
            ...
            <div class="gst-progress-step-animation__step-icon my-4 mx-auto">
                ...
                <IconProgressStep 
                    ...
                    :class="{
                        'gst-progress-step-animation__step-svg--loading': isLoading(index)
                    }" 
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            isCurrent( stepIndex ) {
                return stepIndex === this.activeStep || stepIndex === this.step;
            },
    ...
    .gst-progress-step-animation {
        .gst-progress-step-animation__step {
            ...
            .gst-progress-step-animation__step-icon {
                ...
                .gst-progress-step-animation__step-svg--loading {
                    .gst-svg-icon-progress-step-border {
        ...
        .gst-progress-step-animation__step.current {
            .gst-svg-icon-progress-step-circle {
