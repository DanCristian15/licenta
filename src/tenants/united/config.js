...
export default {
    ...
    theme: {
        ...
        vuetifyOld: {
            ...
            anchor: '#6244BB',
            // gradients
            gradientPrimary1: '#6244BB',
            gradientPrimary2: '#6244BB',
            ...
            homeBannerGradientStart: '#0C2340',
            homeBannerGradientEnd: '#0C2340',
            homeBannerSearchButtonBgColor: '#6244BB',
            footerGradientStart: '#0C2340',
            footerGradientEnd: '#0C2340',
            calendar: '#E92505',
