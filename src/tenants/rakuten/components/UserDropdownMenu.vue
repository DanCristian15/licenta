        ...
        <v-menu
            ...
            <template v-slot:activator="{ on }">
                <v-btn
                    ...
                    <span class="points">{{ userDetail.balance | currencyFull(currency) }}</span>
                    <IconDropDownArrow
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                // TODO: we don't have currency coming on user detail from points.com so we hardcode for now
                currency: 'USD'
            };
        },
        computed: {
            ...mapGetters( {
                userEmail: 'user/profile/getEmail',
            } ),
        }
    };
</script>
<style lang="scss">
    ...
    .gst-user-dropdown-menu {
        ...
        .v-list-item.gst-menu-list__item.gst-menu-list__item--id {
